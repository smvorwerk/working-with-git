...
```bash
$ wget -q -O - --no-check-certificate https://raw.githubusercontent.com/svorwerk-dentsu/working-with-git/develop/improved-gitflow/contrib/gitflow-installer.sh install <state> | bash
```
<hr>
